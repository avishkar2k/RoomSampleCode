...
public class RestaurantLocalRepository {
    ...
    public RestaurantLocalRepository(Context context) {
        RestaurantDatabase restaurantDatabase = RestaurantDatabase.getDatabase(context);
    ...
    private static class insertAllAsyncTask extends AsyncTask<List<RestaurantEntity>, Void, Void> {
